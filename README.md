...
If you find using this script finnicky, check out [Almost Unified](https://modrinth.com/mod/almost-unified) for a mod that functionally does the same thing. You can turn on and off features from this script if you want part of it's functionality but not all of it.
